...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="<c:url value="/madang"/>" method="get" id="book_form">
                ...
                <div class="row">
                    ...
                    <div class="cell-10"><input type="number" data-role="input" name="id" value='${book.price == -1 ? "" : book.price }' id="id" readonly /></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="cell-10"><input type="text" data-role="input" name="price" value='${book.price == -1 ? "" : book.price }' id="price" /></div>
                </div>
                <div class="row">
        ...
        <script src="<c:url value="/p/book.js"/>"></script>
    </body>
</html>