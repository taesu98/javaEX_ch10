    ...
    <body>
        <div data-role="appbar">
            <ul class="app-bar-menu">
                <li><a href="<c:url value="madangControl?action=orderings"/>">주문</a></li>
                <li><a href="<c:url value="madangControl?action=customers"/>">고객</a></li>
                <li><a href="<c:url value="madangControl?action=books"/>">도서</a></li>
            </ul>
        </div>
        ...
        <div class="container">
            ...
            <br/>
            <br/>
            <form action="<c:url value="/madangControl"/>" method="get" id="customer_form">
                <input type="hidden" name="action" value="" id="customer_form_action"/>
                <div class="row">
                    <label class="cell-2">고객번호</label>
                    <div class="cell-10"><input type="number" data-role="input" name="id" value='${customer.id == -1 ? "" : customer.id }' id="id" readonly /></div>
                </div>
                <div class="row">
        ...
        <script src="<c:url value="/EX_ch09/customer.js"/>"></script>
    </body>
</html>