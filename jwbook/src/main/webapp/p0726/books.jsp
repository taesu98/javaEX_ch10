...
<html>
    ...
    <body>
                ...
                <tbody id="books">
                    <c:forEach var="book" items="${bookList}">
                        <tr>
                            <td>
                            <a class="book_id" 
                            href="<c:url value="madangControl?action=book&id=${book.id}"/>" 
                            data-id="${book.id}">
                            ${book.id}
                            </a>
                            </td>
        ...
        <div class="container">
            <form id="goto_form" action="<c:url value="/madangControl"/>" method="post">
        ...
        <script src="<c:url value="/EX_ch09/books.js"/>"></script>
    </body>
</html>