    ...
    <body>
        <div data-role="appbar">
            <ul class="app-bar-menu">
                <li><a href="<c:url value="restaurantControl?action=bills"/>">결제</a></li>
                <li><a href="<c:url value="restaurantControl?action=billsList"/>">결산</a></li>
            </ul>
        </div>
        ...
        <div class="container">
            <h6>선택한 메뉴</h6>
            <form action="<c:url value="restaurantControl?action=addBills"/>" method="post" id="form_bill">
        ...
        <script src="<c:url value="/EX_ch10_Test/addLocale_ko_KR.js"/>"></script>
        <script>
        ...
        <script src="<c:url value="/EX_ch10_Test/restaurant.js"/>" type="module"></script>
    </body>
</html>